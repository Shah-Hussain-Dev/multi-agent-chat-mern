...
export const AuthPage: React.FC<AuthPageProps> = ({ defaultMode = 'login' }) => {
    ...
    const initialMode = (modeParam === 'register' || defaultMode === 'register') ? 'register' : 'login';
    ...
    return (
        <div className="relative min-h-screen w-full bg-zinc-950 text-zinc-100 flex flex-col justify-between p-4 sm:p-6 overflow-x-hidden font-sans selection:bg-emerald-500/30 selection:text-emerald-300">
            {/* Interactive 3D Canvas Background */}
            <Auth3DBackground />

            {/* Background Ambient Glow Spheres */}
            <div className="fixed -top-40 -left-40 w-96 h-96 bg-emerald-600/15 rounded-full blur-[140px] pointer-events-none z-0" />
            <div className="fixed -bottom-40 -right-40 w-96 h-96 bg-teal-600/15 rounded-full blur-[140px] pointer-events-none z-0" />
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-900/10 rounded-full blur-[160px] pointer-events-none z-0" />

            {/* Grid Pattern Overlay */}
            <div className="fixed inset-0 bg-[linear-gradient(to_right,#18181b_1px,transparent_1px),linear-gradient(to_bottom,#18181b_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-30 pointer-events-none z-0" />

            {/* Top Navigation Bar */}
            <header className="relative z-20 w-full max-w-md mx-auto flex items-center justify-between py-2">
                <Link 
                    to="/" 
                    className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-900/80 border border-zinc-800 hover:border-emerald-500/50 hover:bg-zinc-800 text-xs font-medium text-zinc-300 hover:text-white transition-all shadow-sm"
                >
            ...
            <main className="relative z-10 w-full max-w-md mx-auto flex-1 flex flex-col justify-center items-center my-auto py-6">
                <motion.div
                    initial={{ opacity: 0, y: 15 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.4 }}
                    className="w-full bg-zinc-900/85 backdrop-blur-2xl border border-zinc-800/90 rounded-3xl p-6 sm:p-10 shadow-2xl shadow-emerald-950/20"
                >
                    {/* Top Logo & Header */}
                    <div className="flex flex-col items-center text-center space-y-3 mb-6">
                        <div className="relative flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-emerald-500 via-teal-400 to-indigo-500 p-[1px] shadow-lg shadow-emerald-500/20">
                        ...
                        <div className="space-y-1">
                            <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[11px] font-semibold tracking-wide uppercase">
                    ...
                    {isAuthenticated && user && (
                        <div className="mb-5 p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs flex items-center justify-between">
                            <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="px-2.5 py-1 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold rounded-lg text-[11px] transition-colors cursor-pointer"
                            >
                                Go to Chat
                            </button>
                        </div>
                    ...
                    <div className="mt-6 pt-5 border-t border-zinc-800/80 grid grid-cols-3 gap-2 text-center text-[11px] text-zinc-400">
                        <div className="p-2 rounded-lg bg-zinc-950/40 border border-zinc-800/50 flex items-center justify-center gap-1">
            ...
            {/* Footer */}
            <footer className="relative z-10 w-full max-w-md mx-auto py-4 text-center text-xs text-zinc-600">
                &copy; {new Date().getFullYear()} {appName} Inc. Autonomous Swarm Infrastructure.
            </footer>
        </div>
    );
};
